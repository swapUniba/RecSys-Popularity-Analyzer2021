...
#Misura la disuguaglianza (in termini di frequenza) con la quale determinati item vengono raccomandati ai diversi utenti.
...
def run(recs, algorithm_name, ratings):
    ...
    total_num_of_items = len(pd.read_csv('../datasets/goodbooks-10k-master/books.csv').index.values.flatten())
    ...
    ########################### Serializing results-cb-word-embedding ###########################
