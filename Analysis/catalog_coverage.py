...
def run(recs, algorithm_name, ratings):
    #items = set(ML1M('../datasets/ml-1m').movies.index.values.flatten()) Per MovieLens
    items = set(pd.read_csv('../datasets/goodbooks-10k-master/books.csv').index.values.flatten())
